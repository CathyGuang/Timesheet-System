...
EOT;
    ...
    if ($result) {
      ...
      echo "<form class='standard-form' action='index.php' method='post'><input name='name' value='{$_POST['volunteer']}' hidden><button type='submit'>Submit another shift</button></form>";
