...
EOT;
    ...
    if ($result) {
      ...
      echo "<form class='main-form' action='index.php' method='post'><input name='name' value='{$_POST['volunteer']}' style='visibility: hidden;'><button style='height: 10vh' type='submit' value='Submit another shift'></button></form>";
