<?php
  if ($QUERY_NAME == "ALL") {
    $query = <<<EOT
    SELECT DISTINCT class_type, classes.id, cancelled, date_of_class, start_time, end_time, lesson_plan, tacks, special_tack, stirrup_leather_length, pads, horses, staff, volunteers, attendance FROM classes;
EOT;
  } else {
