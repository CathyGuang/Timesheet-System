...
EOT;
    ...
    if ($result) {
      ...
      echo "<form action='index.php' method='post'><input name='name' value='{$_POST['volunteer']}' style='visibility: hidden;'><button type='submit' value='Submit another shift'></button></form>"
