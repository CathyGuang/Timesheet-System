...
EOT;
    ...
    if ($result) {
      ...
      echo "<form class='main-content-header' action='index.php' method='post'><input name='name' value='{$_POST['volunteer']}' style='visibility: hidden;'><button type='submit' value='Submit another shift'></button></form>";
