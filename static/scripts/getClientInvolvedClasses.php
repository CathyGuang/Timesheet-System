<?php
  ...
  $query = <<<EOT
  SELECT class_type, display_title, classes.id, cancelled, date_of_class, start_time, end_time, lesson_plan, tacks, special_tack, stirrup_leather_length, pads, horses, staff, volunteers, attendance FROM classes WHERE
