...
<link href="https://fonts.googleapis.com/css?family=Nunito:700&display=swap" rel="stylesheet">
  ...
  <title>Full Daily Schedule</title>
</head>
...
<body>
  ...
  <div class="schedule-header">
    ...
    <div style="display: flex; justify-content: space-between; background-color: var(--background-purple);">
      ...
      <div style="display: inherit;">
        ...
        <button class="green-button" type="submit" form="new-schedule" style="height: 41.5pt; max-width: 50px;">GO</button>
      </div>
