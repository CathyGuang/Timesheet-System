    ...
    <form autocomplete="off" action="check.php" method="post" class="standard-form standard-form">
      ...
      <div class="form-section">
        <div class="form-element">
          ...
          <input type="time" id="start-time" name="start-time" value="<?php echo date('h:iA') ?>" required>
        </div>
        <div class="form-element">
          <label for="end-time">to:</label>
          <input type="time" id="end-time" name="end-time" value="<?php echo date('h:iA', strtotime('+1 hour')) ?>" required>
        </div>
      </div>
