...
<body class= "full-time-report" style="background-color:#BDF4D0;min-width:1226px;background-image: url('/full-time-staff/enter-hours/hor.png')">
   
  <img src="holiday.png" class= "holiday_horse" alt="horse picture">
  ...
  <div class= "fulltime-form-container" >
    ...
    <form class="white-background" method="post" name="myform" id="myform" action="full-time.php" style = "border-radius: 20px;">
